...
class AppColors {
  ...
  static final Color overlay = Color.fromRGBO(0, 0, 0, 0.1);

  //Purples
  static final Color purple = Color(0xFF8257E5);
  static final Color lightPurple = Color(0xFFede6ff);
  ...
  static final Color lighterGrey = Color(0xFFDBD8E3);
  static final Color moreLighterGrey = Color(0xFFf4F2F7);
  ...
  static final Color darkerGreen = Color(0xFF00B852);
